      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              <button className='bg-zinc-800 text-zing-200 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700' onClick={closeGuestsInput}>
                Alterar local/data
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type='button' className='flex flex-1 items-center gap-2' onClick={openGuestsModal}>
        ...
        <p className="text-sm text-zinc-500">
          Ao planejar sua viagem com plann.er você automaticamente concorda <br />
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              ...
              <p className='text-sm text-zinc-400'>
                Os convidados irão recebere e-mails para confirmar a participação na viagem.
              </p>
